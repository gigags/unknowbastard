...
f.C=function(a){a.id=this.g;a.channel="widget";a=Ia(a);var b=this.b;var c=Qa(this.a.src);b=0==c.indexOf("https:")?[c]:b.b?[c.replace("http:","https:")]:b.f?[c]:[c,c.replace("http:","https:")];if(!this.a.contentWindow)throw Error("The YouTube player is not attached to the DOM.");for(c=0;c<b.length;c++)try{this.a.contentWindow.postMessage(a,"*")}catch(d){if(d.name&&"SyntaxError"==d.name)Wa(d,"WARNING");else throw d;}};Ma(new Na);Ma(new Oa);function ob(a){return(0==a.search("cue")||0==a.search("load"))&&"loadModule"!=a}
...
f.s=function(){var a=T(this.b,"playerVars");if(a){var b={},c;for(c in a)b[c]=a[c];a=b}else a={};window!=window.top&&document.referrer&&(a.widget_referrer=a.widget_referrer);return a};
